...
function ResetPasswordInner() {
  ...
  // 실시간 일치 표시 — 확인 칸에 입력이 있을 때만
  const showMatch = pwConfirm.length > 0;
          ...
          <>
            ...
            <form onSubmit={onSubmit} className={styles.form}>
              ...
              <div className="form-group">
                ...
                {showMatch && (
                  <p className={`${styles.matchHint} ${isMatch ? styles.matchOk : styles.matchNo}`}>
...
/** 비밀번호 표시/숨김 아이콘 (off=현재 표시 중이라 '숨기기' 모양) */
